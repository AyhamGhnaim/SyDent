...
- **الرقمان `56`/`57` استُخدما مرّتين** (watch-point #10): جلسة المخطّط v80 طبّقتهما
  ...
  الزمني — على القاعدة الحيّة هما no-op (idempotent). **الرقم 59 استُهلك لاحقاً (`59_booking_portal.sql` — P5 بوابة الحجز، مطبّق). الترقيم التالي يبدأ من 61 (الرقم 60 استُهلك: `60_booking_window_dynamic.sql` — نافذة حجز ديناميكية (قيمة الدكتور تحكم، سقف مطلق 365 يوم على الـ anon endpoint)).**
